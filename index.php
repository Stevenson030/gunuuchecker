		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					<h4 class="mb-2"><strong>GUNNU</strong></h4>

					<textarea rows="12" class="form-control text-center form-checker mb-2" placeholder="PUT _YOUR_CARDS_HERE"></textarea>
					<textarea rows="1" class="form-control text-center" id="sec" placeholder="sk_live_xxxxxxxxxxxx"></textarea></br>
...
Swal.fire({ title: "@LIVE_CC_BIN", text: "Join Our Telegram Channel :(", icon: "warning", confirmButtonText: "OK", buttonsStyling: false, confirmButtonClass: 'btn btn-primary'});
